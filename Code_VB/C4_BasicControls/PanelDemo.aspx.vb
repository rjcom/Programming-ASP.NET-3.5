...
Partial Class PanelDemo
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        ...
        Dim strText As String = "<p>Four score and seven years ago our fathers brought forth, upon this continent, a new nation, conceived in liberty, and dedicated to the proposition that &#8220;all men are created equal.&#8221;</p>"
    ...
    Protected Sub ddlScrollBars_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs) Handles ddlScrollBars.SelectedIndexChanged
        ...
        Dim strValue As String = ddl.SelectedValue
        Dim scrollBar As ScrollBars = DirectCast([Enum].Parse(GetType(ScrollBars), strValue), ScrollBars)
