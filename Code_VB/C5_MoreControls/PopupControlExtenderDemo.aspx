<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PopupControlExtenderDemo.aspx.vb" Inherits="PopupControlExtenderDemo" %>
...
<body>
   ...
   <div>
      ...
      <asp:UpdatePanel ID="pnlChoice" runat="server">
         <ContentTemplate>
            <asp:Label ID="Label1" runat="server" Text="Pick one of the following publishers" />
