...
Partial Class UpdateProgressDemo
    ...
    Protected Sub btnAsyncPostback_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAsyncPostback.Click
