<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TabPanelStylesDemo.aspx.vb" Inherits="TabPanelStylesDemo" %>
...
<body>
    ...
    <cc1:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" CssClass="DemoStyles" >
        ...
        <cc1:TabPanel runat="server" HeaderText="TabPanel2" ID="TabPanel2">
            ...
            <ContentTemplate>
                You can then specify child classes that you can set in order to style individual elements in the tab panels. 
                For instance, to set the style of the tabs contents, you'd create a style as follows.
            </ContentTemplate>
        </cc1:TabPanel>
    </cc1:TabContainer>
    </form>
