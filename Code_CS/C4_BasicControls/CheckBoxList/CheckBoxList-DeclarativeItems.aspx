<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CheckBoxList-DeclarativeItems.aspx.cs"
...
<body>
   <!--
      ...
      Switch to design view and use Collection Editor to add other three items. In common teasks dialog, choose add items.
