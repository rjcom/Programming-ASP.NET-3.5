...
<head>
   <title>ValidationGroup Demo</title>
</head>
<body>
   <h1>
      Bug Reporter
   ...
   <table cellpadding="3" border="1">
      ...
      <tr>
         ...
         <td>
            ...
            <asp:DropDownList ID="ddlBooks" runat="server" ValidationGroup="Bug">
      ...
      <tr>
         ...
         <td>
            <asp:RadioButtonList ID="rblEdition" RepeatLayout="Flow" runat="server" ValidationGroup="Bug">
         ...
         <td>
            <asp:RequiredFieldValidator ID="rfvEdition" runat="server" ControlToValidate="rblEdition"
               Display="Static" ErrorMessage="Please pick an edition" Text="*" ValidationGroup="Bug" />
         </td>
      </tr>
      <tr>
         <td>
         ...
         <td>
            <asp:RequiredFieldValidator ID="rfvBug" ControlToValidate="txtBug" Display="Static"
               runat="server" ErrorMessage="Please provide bug details" Text="*" ValidationGroup="Bug" />
         </td>
      </tr>
      <tr>
         <td>
         ...
         <td>
            <asp:RequiredFieldValidator runat="server" ID="rfvPageNumber" ControlToValidate="txtPageNumber"
               ErrorMessage="You did not enter the page number" Text="*" ValidationGroup="Bug" />
      ...
      <tr>
         <td colspan="3" align="center">
            <asp:Button ID="btnSubmit" Text="Submit Bug" runat="server" ValidationGroup="Bug" />
         </td>
      </tr>
      ...
      <tr>
         ...
         <td>
            ...
            <asp:RequiredFieldValidator runat="server" ID="rfvPassword1" ControlToValidate="txtPassword1"
               ErrorMessage="Please enter your password" Text="*" ValidationGroup="Login" />
         </td>
      </tr>
      ...
      <tr>
         ...
         <td>
            ...
            <asp:RequiredFieldValidator runat="server" ID="rfvPassword2" ControlToValidate="txtPassword2"
               ErrorMessage="Please re-enter your password" Text="*" ValidationGroup="Login" />
