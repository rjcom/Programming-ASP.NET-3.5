...
<head runat="server">
    <title>Custom Validator Demo</title>
</head>
<body>
   <script type="text/javascript" language="javascript">
      function IsNumberEven(source, args)
      {
         if (args.Value % 2 == 0)
            args.IsValid=true;
         else
   ...
   <table cellpadding="3" border="1">
      ...
      <tr>
         ...
         <td>
            ...
            <asp:RangeValidator ID="rngPriority" runat="server" Text="*" 
               ErrorMessage="Priorty must be between 1 (high) and 7 (low)"
      ...
      <tr>
         ...
         <td>
            <asp:RequiredFieldValidator ID="rfvEmail" runat="server" 
               ErrorMessage="Please enter an email address" Text="*"
      ...
      <tr>
         <td>Are you human?<br />Enter an even number</td>
         <td>
            <asp:TextBox ID="txtEvenNumber" runat="server" />
         </td>
         <td>
            <asp:RequiredFieldValidator runat="server" ID="rfvEvenNumber" ControlToValidate="txtEvenNumber"
               ErrorMessage="Please enter an even number" Text="*" />
            <asp:CustomValidator runat="server" ID="cvalEvenNumber" ControlToValidate="txtEvenNumber"
               ErrorMessage="No odd numbers please" Text="*" ValidateEmptyText="false"
               ClientValidationFunction="IsNumberEven" 
               onservervalidate="cvalEvenNumber_ServerValidate" />
         </td>
      </tr>
      <tr>
         <td colspan="3" align="center">
